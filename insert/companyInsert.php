...
if(isset($_POST['insert'])){
  ...
  include '../navigation/adminNavigation.php'; 
    ...
    $sql2  = "INSERT INTO `company`(`CompanyID`, `Company_Name`, `Owner_ID`) VALUES ('$companyid','$companyname','$Owner_ID')";
...
<h1>INSERT PROPERTY OWNER</h1>
      ...
      <form action="" method="POST">
        ...
        <input type="text" name="companyid" placeholder="Compamy ID" ><br><br>
